...
__all__ = ['plot_graph', 'plot_graph_as_quiver', 'is_in_edges_', 'VoronoiRegions2Edges', 'Vertex', 'Graph', 'Monolayer']
...
def plot_graph_as_quiver(g,quiver_kwargs = {'units':'xy','angles':'xy',
    ...
    # vertices with edges:
    plt.quiver(vx[g.edges[:,0],0],vx[g.edges[:,0],1],edge_dirs[:,0],edge_dirs[:,1],**quiver_kwargs)
    plt.axis(False);
